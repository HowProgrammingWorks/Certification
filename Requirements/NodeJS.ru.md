# Node.js сертификация от Метархии
...
без записи. Выбрать это можно до или после прохождения экзамена. Запись
прохождения сертификации, по желанию претендента, может быть опубликована в
...
Продолжительность сертификации составляет от 30 минут до 2 часов, но
